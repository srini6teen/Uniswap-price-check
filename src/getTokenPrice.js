  ...
  const DAI = new UNISWAP.Token(UNISWAP.ChainId.MAINNET, tokenAddress, decimal);
  ...
  try {
    let tokenAmount = new UNISWAP.TokenAmount(UNISWAP.WETH[DAI.chainId], "1000000000000000000");
